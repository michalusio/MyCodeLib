    ...
    public class Onp
    {
        ...
        public Queue<string> Parse(string formula)
        {
            ...
            for (var index = 1; index < stringBuilder.Length; ++index)
                if (stringBuilder[index] == 45 && Figures.ContainsKey(stringBuilder[index - 1]) &&
                    stringBuilder[index - 1] != 41)
                    stringBuilder[index] = 'N';
            formula = stringBuilder.ToString();
            var stringQueue = new Queue<string>();
            var source = new Stack<char>();
            var str = "";
        ...
        {
            var source = new Stack<double>();
            foreach (var str in formula)
                if (str.Length == 1)
                {
                    var ch = str[0];
                    if (x.ContainsKey(ch))
                        ...
                        if (ch <= 37U)
                            ...
                            switch (ch)
                            {
                                ...
                                case 'G':
                                    ...
                                    continue;
                                case 'I':
                                    var num11 = source.Pop();
                                    var num12 = source.Pop();
                                ...
                                case 'U':
                                    ...
                                    continue;
                                case '[':
                                    var num13 = source.Pop();
                                    var num14 = source.Pop();
                                    source.Push(num14 <= num13 ? 1.0 : 0.0);
                                    continue;
                                case ']':
                                    var num15 = source.Pop();
                                    var num16 = source.Pop();
