...
namespace Useful.Functions
{
    ...
    public static class ExpressionTree
    {
        ...
        {
            Onp onp = new Onp();
            var stringQueue = onp.Parse(formula);
        ...
        {
            var stringQueue = o.Parse(formula);
            var treeNodeList = new List<TreeNode>();
            foreach (var s in stringQueue)
        ...
        public static double SolveTree(TreeNode q, Dictionary<char, double> x)
        {
            ...
            if (ch <= 37U)
                ...
                {
                    result = Math.Abs(SolveTree(q.Leafs[0], x) - SolveTree(q.Leafs[1], x)) > 2.80259692864963E-45
                        ? 1.0
                        : 0.0;
                }
            else
        ...
        {
            for (var index = 0; index < q.Leafs.Count; ++index)
            ...
            if (ch <= 47U)
                switch (ch)
                {
                    case '%':
                        double result1;
                        var flag1 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result1);
                        double result2;
                        var flag2 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result2);
                        if (flag1 & flag2)
                            return new TreeNode(Extensions.Mod(result1, result2).ToString(Extensions.Nfi));
                        if (flag1 && Math.Abs(result1) < 4.94065645841247E-323 ||
                            flag2 && Math.Abs(result2 - 1.0) < 4.94065645841247E-323)
                    ...
                    case '*':
                        double result3;
                        var flag3 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result3);
                        double result4;
                        var flag4 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result4);
                        if (flag3 & flag4)
                            return new TreeNode((result3 * result4).ToString(Extensions.Nfi).Replace(',', '.'));
                        if (flag3 && Math.Abs(result3) < 4.94065645841247E-323 ||
                            flag4 && Math.Abs(result4) < 4.94065645841247E-323)
                            return new TreeNode("0");
                    ...
                    case '+':
                        double result5;
                        var flag5 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result5);
                        double result6;
                        var flag6 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result6);
                        if (flag5 & flag6)
                    ...
                    case '-':
                        double result7;
                        var flag7 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result7);
                        double result8;
                        var flag8 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result8);
                        if (flag7 & flag8)
                    ...
                    case '/':
                        double result9;
                        var flag9 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result9);
                        double result10;
                        var flag10 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result10);
                        if (flag9 & flag10)
                ...
                switch (ch)
                {
                    ...
                    case '^':
                        ...
                        double result24;
                        var flag11 = double.TryParse(q.Leafs[0].Element, NumberStyles.Any, Extensions.Nfi, out result24);
                        double result25;
                        var flag12 = double.TryParse(q.Leafs[1].Element, NumberStyles.Any, Extensions.Nfi, out result25);
                        if (flag11 & flag12)
